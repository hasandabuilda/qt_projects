// /qt/qml/CrazyPoppers/LevelSelectOverlay.qml
...
0xd4,0xb,0x0,0x0,0xeb,0x7a,0x21,0xad,
0x9b,0xa,0xd3,0x25,0x9e,0xfa,0xfd,0x9b,
0xa2,0x4b,0x86,0xa,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0x64,0x0,0x0,0x0,0xe3,0x1,0x0,0x0,
...
0x34,0x3,0x0,0x0,0x2,0x0,0x0,0x0,
...
0x6,0x0,0x50,0x0,0xac,0x0,0x0,0x0,
...
Q_UNUSED(aotContext)
Q_UNUSED(argv)
// expression for model at line 18, column 13
struct Storage : QQmlPrivate::AOTTrackedLocalsStorage {
Storage(const QQmlPrivate::AOTCompiledContext *ctxt, void **a)   : aotContext(ctxt), argv(a) {}
void markObjects(QV4::MarkStack *markStack) const final {    Q_UNUSED(markStack);
    aotContext->mark(v2_0, markStack);
...
#endif
while (!aotContext->getObjectLookup(4, s.v2_2, &s.v2_4)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(6);
#endif
aotContext->initGetObjectLookupAsVariant(4, s.v2_2);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<QVariant *>(argv[0]) = QVariant();
